...
- [x] P0 — Replace the mic button with Spacebar microphone toggle UI, including enabled/disabled/connecting status and no button-rendered microphone control — spec: `specs/00-openai-realtime-port.md`
